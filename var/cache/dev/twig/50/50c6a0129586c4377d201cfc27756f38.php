...
class __TwigTemplate_cb0b468f75ef754bd7e5d124cbef4856 extends Template
{
    ...
    <div class=\"container-fluid\">
      ...
      <div class=\"collapse navbar-collapse\" id=\"navbarPirata\">
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "request", [], "any", false, false, false, 11), "get", ["_route"], "method", false, false, false, 11) == "repositories")) {
            ...
            // line 14
            yield "              <a class=\"nav-link text-white\" style=\"user-select: none;\" href=\"";
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("repositories");
        ...
        yield "          </li>
          <li class=\"nav-item\">
            <button class=\"nav-link text-white\" style=\"user-select: none;\" data-bs-toggle=\"modal\" data-bs-target=\"#CrearRepositorio\"><i class=\"bi bi-folder-plus me-1\"></i>Crear Repositorio</button>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class=\"collapse navbar-collapse\" id=\"navbarPirata\">
        <ul class=\"navbar-nav me-auto mb-2 mb-lg-0\">
          <li class=\"nav-item\">
            ...
            {% else %}
              <a class=\"nav-link text-white\" style=\"user-select: none;\" href=\"{{ path('repositories') }}\"><i class=\"bi bi-archive me-1\"></i>Mis Repositorios</a>
            {% endif %}
          </li>
          <li class=\"nav-item\">
            <button class=\"nav-link text-white\" style=\"user-select: none;\" data-bs-toggle=\"modal\" data-bs-target=\"#CrearRepositorio\"><i class=\"bi bi-folder-plus me-1\"></i>Crear Repositorio</button>
...
{% endblock %}
", "navbarRepo.html.twig", "C:\\Users\\ivin0\\Desktop\\KrakenVault\\templates\\navbarRepo.html.twig");
    }
}
