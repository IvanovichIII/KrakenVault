 ...
 */
class getHistorialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistorialRepository' shared autowired service.
     *
     * @return \App\Repository\HistorialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistorialRepository.php';

        return $container->privates['App\\Repository\\HistorialRepository'] = new \App\Repository\HistorialRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
